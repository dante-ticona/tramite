            ...
            funderivarCasoForzadoUnitaria(e) {
                ...
                if (orden == '30' && this.registro.act_data.act_siguiente != 20) {
                    this.GetSolicitudPrestaciones(this.registro.cas_id, e, this.registro.cas_data)
                        .then(idprestaciones => {
                            console.log("idprestaciones:", idprestaciones);
                    ...
                    axios.post('/api/SolicitudPrestacion', datos)
                        .then(response => {
                            if (response.data.data.length === 0) {
                                ...
                                if (vtipoproceso != 'GFU') {
                                    console.log("INGRESANDO .... juan ", jsonDataDH);
                                    jsonDataDH.forEach((dhArray, index) => {
                                        ...
                                        console.log("valorOriginal .... juan ", valorOriginal);
                                        var valorDeseado = "";
                                    ...
                                    console.log('participantesSolicituddh',participantesSolicituddh);
                                }
                                //*************************TITULAR******************* */
                                      console.log('jsonDataDoc',jsonData);
                                      console.log('jsonData======juan jsonData',jsonData);
                                      const respaldosArrayT = this.buscarContenidoPorIdPersonaSip(jsonData, AS_IDPERSONA.replace(/\s/g, ''));
                                      console.log('respaldosArrayT',respaldosArrayT);
                                const participanteT = {
                                ...
                                console.log('participanteT',participanteT);
