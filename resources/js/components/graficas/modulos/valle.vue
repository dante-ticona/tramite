                  ...
                  <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                      ...
                      <div class="col-12 col-sm-4">
                          ...
                          <div class="info-box-content">
                              <img src="img/departamentos/cochabamba.png" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="La PAZ">
                              <center> <span class="badge bg-primary text-center">{{ lapaz }}</span>  </center>
                              <span class="info-box-text text-center text-muted">COCHABAMBA</span>
                          </div>
                          </div>
                      </div>
                      <div class="col-12 col-sm-4">
                          <div class="info-box bg-light">
                          <div class="info-box-content">
                              <img src="img/departamentos/chuquisaca.png" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="ORURO">
                              <center> <span class="badge bg-primary text-center">{{ oruro }}</span></center>
                              <span class="info-box-text text-center text-muted">CHUQUISACA</span>
                          </div>
                          </div>
                      </div>
                      <div class="col-12 col-sm-4">
                          <div class="info-box bg-light">
                          <div class="info-box-content">
                              <img src="img/departamentos/tarija.png" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="POTOSI">
                              <center> <span class="badge bg-primary text-center">{{ potosi }}</span></center>
                              <span class="info-box-text text-center text-muted">TARIJA</span>
                          </div>
                          </div>
                      </div>
                      </div>
