                    ...
                    <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            <div class="info-box-content">
                                <img src="img/departamentos/webp/la paz.webp" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="La PAZ">
                                <center> <span class="badge bg-primary text-center">{{ lapaz }}</span>  </center>
                                <span class="info-box-text text-center text-muted">LA PAZ</span>
                            </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="info-box bg-light">
                            <div class="info-box-content">
                                <img src="img/departamentos/webp/oruro.webp" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="ORURO">
                                <center> <span class="badge bg-primary text-center">{{ oruro }}</span></center>
                                <span class="info-box-text text-center text-muted">ORURO</span>
                            </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="info-box bg-light">
                            <div class="info-box-content">
                                <img src="img/departamentos/webp/potosi.webp" style="width: 20%; height: auto; display: block; margin: 0 auto 5px;" alt="POTOSI">
                                <center> <span class="badge bg-primary text-center">{{ potosi }}</span></center>
                                <span class="info-box-text text-center text-muted">POTOSI</span>
                            </div>
                            </div>
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div style="display: flex; align-items: center;">
                                    <img src="img/asistente_sip.gif" alt="TramiteSIP" style="width: 50px; height: auto; margin-right: 10px;">
