<template>
    <div style="height: 500px; width: 100%; border: 1px solid #ddd; border-radius: 10px; padding: 10px;">
      <div class="controls">
    ...
    <div v-if="SinRegistros" class="sin-registros">Sin Registros Existentes</div>
        <v-chart v-else :option="chartOptions"></v-chart>
    </div>
</template>
    ...
    computed: {
        ...
        return {
            ...
            series: [{
                ...
                type: 'bar',
                barWidth: '60%',
                barCategoryGap: '20%', // espacio entre barras
