function estaCheck(){
    ...
    if(palabras[0]=="3")
    {
      ...
      document.getElementById("DH_GRADO0").style.display = "block";

      console.log("so");
    } else {
      document.getElementById("DH_GRADO0").style.display = "none";
      elemento.style.display = "none"; // Ocultar el elemento
    }


    if(palabras[0] =="1" && palabras[1] =="CONY"){
        document.getElementById("DH_MATRIMONIO0").style.display = "block";
    } else {
      document.getElementById("DH_MATRIMONIO0").style.display = "none";
    }
  ...
  function fechaForm985(){
      if (document.getElementById("AS_TIPO_EAP").value === "CVEAP-B6") {
          ...
          document.getElementById("FORM_JUB_FECHA").value = fechaHoy;
          document.getElementById("FORM_JUB_FECHA").dispatchEvent(new Event('input'));
      }
